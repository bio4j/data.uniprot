...
sealed trait ResourceAbbreviation {
  ...
  case object DEPOD                 extends ResourceAbbreviation { val description: String = "DEPOD human dephosphorylation database" }
  ...
  case object MoonProt              extends ResourceAbbreviation { val description: String = "MoonProt database of moonlighting proteins" }
  ...
  case object Proteomes             extends ResourceAbbreviation { val description: String = "hola UniProt!" }
  ...
  case object `SWISS-2DPAGE`        extends ResourceAbbreviation { val description: String = "2D-PAGE database from the Geneva University Hospital (SWISS-2DPAGE)" }
...
case object ResourceAbbreviation {
  ...
  def fromString(rep: String): ResourceAbbreviation =
    rep match {
      case "EMBL"  => EMBL
      case "Allergome" => Allergome
      case "ArachnoServer" => ArachnoServer
      case "Bgee" => Bgee
      case "BindingDB" => BindingDB
      case "BioCyc" => BioCyc
      case "BioGrid" => BioGrid
      case "BioMuta" => BioMuta
      case "BRENDA" => BRENDA
      case "CAZy" => CAZy
      case "CCDS" => CCDS
      case "CDD" => CDD
      case "ChEMBL" => ChEMBL
      case "ChiTaRS" => ChiTaRS
      case "CGD" => CGD
      case "CleanEx" => CleanEx
      case "COMPLUYEAST-2DPAGE" => `COMPLUYEAST-2DPAGE`
      case "CollecTF" => CollecTF
      case "ConoServer" => ConoServer
      case "CTD" => CTD
      case "dictyBase" => dictyBase
      case "DEPOD" => DEPOD
      case "DIP" => DIP
      case "DMDM" => DMDM
      case "DNASU" => DNASU
      case "DOSAC-COBS-2DPAGE" => `DOSAC-COBS-2DPAGE`
      case "DisProt" => DisProt
      case "DrugBank" => DrugBank
      case "EchoBASE" => EchoBASE
      case "EcoGene" => EcoGene
      case "eggNOG" => eggNOG
      case "Ensembl" => Ensembl
      case "EnsemblBacteria" => EnsemblBacteria
      case "EnsemblFungi" => EnsemblFungi
      case "EnsemblMetazoa" => EnsemblMetazoa
      case "EnsemblPlants" => EnsemblPlants
      case "EnsemblProtists" => EnsemblProtists
      case "EPD" => EPD
      case "ESTHER" => ESTHER
      case "euHCVdb" => euHCVdb
      case "EuPathDB" => EuPathDB
      case "EvolutionaryTrace" => EvolutionaryTrace
      case "ExpressionAtlas" => ExpressionAtlas
      case "FlyBase" => FlyBase
      case "Gene3D" => Gene3D
      case "GeneCards" => GeneCards
      case "GeneDB" => GeneDB
      case "GeneID" => GeneID
      case "GeneReviews" => GeneReviews
      case "GeneWiki" => GeneWiki
      case "GenomeRNAi" => GenomeRNAi
      case "GeneTree" => GeneTree
      case "Genevisible" => Genevisible
      case "GO" => GO
      case "Gramene" => Gramene
      case "GuidetoPHARMACOLOGY" => GuidetoPHARMACOLOGY
      case "HGNC" => HGNC
      case "H-InvDB" => `H-InvDB`
      case "HAMAP" => HAMAP
      case "HOGENOM" => HOGENOM
      case "HOVERGEN" => HOVERGEN
      case "HPA" => HPA
      case "InParanoid" => InParanoid
      case "IntAct" => IntAct
      case "InterPro" => InterPro
      case "IPI" => IPI
      case "iPTMnet" => iPTMnet
      case "KEGG" => KEGG
      case "KO" => KO
      case "LegioList" => LegioList
      case "Leproma" => Leproma
      case "MaizeGDB" => MaizeGDB
      case "MalaCards" => MalaCards
      case "MaxQB" => MaxQB
      case "MEROPS" => MEROPS
      case "MGI" => MGI
      case "MIM" => MIM
      case "MINT" => MINT
      case "mycoCLAP" => mycoCLAP
      case "MoonProt" => MoonProt
      case "neXtProt" => neXtProt
      case "OGP" => OGP
      case "OMA" => OMA
      case "Orphanet" => Orphanet
      case "OrthoDB" => OrthoDB
      case "PANTHER" => PANTHER
      case "PATRIC" => PATRIC
      case "PaxDb" => PaxDb
      case "PDB" => PDB
      case "PDBsum" => PDBsum
      case "PeptideAtlas" => PeptideAtlas
      case "PeroxiBase" => PeroxiBase
      case "Pfam" => Pfam
      case "PharmGKB" => PharmGKB
      case "PhosphoSite" => PhosphoSite
      case "PhylomeDB" => PhylomeDB
      case "PIR" => PIR
      case "PIRSF" => PIRSF
      case "PMAP-CutDB" => `PMAP-CutDB`
      case "PomBase" => PomBase
      case "PRIDE" => PRIDE
      case "PRINTS" => PRINTS
      case "ProDom" => ProDom
      case "PRO" => PRO
      case "ProMEX" => ProMEX
      case "PROSITE" => PROSITE
      case "ProteinModelPortal" => ProteinModelPortal
      case "Proteomes" => Proteomes
      case "PseudoCAP" => PseudoCAP
      case "Reactome" => Reactome
      case "REBASE" => REBASE
      case "RefSeq" => RefSeq
      case "REPRODUCTION-2DPAGE" => `REPRODUCTION-2DPAGE`
      case "RGD" => RGD
      case "SABIO-RK" => `SABIO-RK`
      case "SGD" => SGD
      case "SignaLink" => SignaLink
      case "SIGNOR" => SIGNOR
      case "SMART" => SMART
      case "SMR" => SMR
      case "STRING" => STRING
      case "SUPFAM" => SUPFAM
      case "SWISS-2DPAGE" => `SWISS-2DPAGE`
      case "SwissLipids" => SwissLipids
      case "SwissPalm" => SwissPalm
      case "TAIR" => TAIR
      case "TCDB" => TCDB
      case "TIGRFAMs" => TIGRFAMs
      case "TopDownProteomics" => TopDownProteomics
      case "TreeFam" => TreeFam
      case "TubercuList" => TubercuList
      case "UCD-2DPAGE" => `UCD-2DPAGE`
      case "UniGene" => UniGene
      case "UCSC" => UCSC
      case "UniCarbKB" => UniCarbKB
      case "UniPathway" => UniPathway
      case "VectorBase" => VectorBase
      case "World-2DPAGE" => `World-2DPAGE`
      case "WormBase" => WormBase
      case "WBParaSite" => WBParaSite
      case "Xenbase" => Xenbase
      case "ZFIN" => ZFIN
  }
}
